package com.example.rubby.OverridedWidgets.ExpandableRecyclerView;
...
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.listeners.ExpandCollapseListener;
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.listeners.GroupExpandCollapseListener;
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.listeners.OnGroupClickListener;
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.models.ExpandableGroup;
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.models.ExpandableList;
import com.example.rubby.OverridedWidgets.ExpandableRecyclerView.models.ExpandableListPosition;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
  ...
  public void expandGroup(int flatPos) {
      ExpandableListPosition listPos = expandableList.getUnflattenedPosition(flatPos);
      expandableList.expandedGroupIndexes[listPos.groupPos] = true;
      notifyItemRangeInserted(expandableList.getFlattenedGroupIndex(listPos) + 1,
            expandableList.groups.get(listPos.groupPos).getItemCount());
  }
   ...
   * {@linkExpandableRecyclerViewAdapter} is attached to.
   * <p>
   *
   ...
   *
   * @param viewType an int returned by {@linkExpandableRecyclerViewAdapter#getItemViewType(int)}
